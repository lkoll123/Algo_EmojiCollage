...
#the function emojiRGB calls both cropSquare and emojiread for all emojis in folder, taking in a list inputarr and appending all averageRGB values, generated by the emojiread function, to inputarr
#takes in an empty list (inputarr) and the path where the emojis are stored (pathToPics). Returns a sort
